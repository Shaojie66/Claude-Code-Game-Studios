...
| **CONCERNS [list]** | Issues present but not blocking. | Surface to the user in conversation, then capture the decision with `ask_user_dictation` if input is needed. |
