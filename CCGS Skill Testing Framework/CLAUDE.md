# CCGS Skill Testing Framework — Legacy Local Instructions
...
2. Read the skill at `.codex/skills/studio-[name]/SKILL.md`
...
Nothing in the active `.codex/` runtime imports from here. Deleting this folder has no effect on the
