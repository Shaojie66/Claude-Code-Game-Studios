...
**Fixture:**
- `.codex/skills/studio-some-skill/SKILL.md` has 2 static failures:
...
4. Skill asks "May I write improvements to `.codex/skills/studio-some-skill/SKILL.md`?"
...
**Fixture:**
- `.codex/skills/studio-some-skill/SKILL.md` has 1 static failure (missing handoff)
...
**Fixture:**
- `.codex/skills/studio-gate-check/SKILL.md` is a gate skill with 1 static failure
...
4. "May I write improvements to `.codex/skills/studio-gate-check/SKILL.md`?"
...
**Fixture:**
- `.codex/skills/studio-brainstorm/SKILL.md` has no static failures
