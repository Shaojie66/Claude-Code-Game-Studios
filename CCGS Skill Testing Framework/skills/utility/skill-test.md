...
- **audit**: Produces a coverage table of all skills in `.codex/skills/studio-` and
  all agents in `.codex/prompt-sources/studio/`, showing which have spec files and which do not.
...
**Fixture:**
- `.codex/skills/studio-brainstorm/SKILL.md` exists and is well-formed:
...
**Expected behavior:**
1. Skill reads `.codex/skills/studio-brainstorm/SKILL.md`
...
**Fixture:**
- `.codex/skills/studio-some-skill/SKILL.md` has `Write` in `allowed-tools` frontmatter
...
- `.codex/skills/studio-gate-check/SKILL.md` exists
...
**Fixture:**
- `.codex/skills/studio-` contains 72+ skill directories
- `.codex/prompt-sources/studio/` contains 49+ agent files
- `tests/skills/` contains spec files for a subset of skills

**Input:** `/skill-test audit`

**Expected behavior:**
1. Skill enumerates all skills in `.codex/skills/studio-` and all agents in `.codex/prompt-sources/studio/`
...
- `.codex/skills/studio-gate-check/SKILL.md` is a gate skill
