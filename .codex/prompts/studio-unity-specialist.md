# studio-unity-specialist

This prompt is generated from the canonical Codex-native source at `.codex/prompt-sources/studio/unity-specialist.md`.

- Source role: `unity-specialist`
