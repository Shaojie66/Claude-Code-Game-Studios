# studio-performance-analyst

This prompt is generated from the canonical Codex-native source at `.codex/prompt-sources/studio/performance-analyst.md`.

- Source role: `performance-analyst`
