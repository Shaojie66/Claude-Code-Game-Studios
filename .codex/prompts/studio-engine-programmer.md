# studio-engine-programmer

This prompt is generated from the canonical Codex-native source at `.codex/prompt-sources/studio/engine-programmer.md`.

- Source role: `engine-programmer`
