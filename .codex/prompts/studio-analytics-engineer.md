# studio-analytics-engineer

This prompt is generated from the canonical Codex-native source at `.codex/prompt-sources/studio/analytics-engineer.md`.

- Source role: `analytics-engineer`
