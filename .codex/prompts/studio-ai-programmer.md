# studio-ai-programmer

This prompt is generated from the canonical Codex-native source at `.codex/prompt-sources/studio/ai-programmer.md`.

- Source role: `ai-programmer`
