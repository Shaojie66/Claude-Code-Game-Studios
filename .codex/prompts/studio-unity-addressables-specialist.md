# studio-unity-addressables-specialist

This prompt is generated from the canonical Codex-native source at `.codex/prompt-sources/studio/unity-addressables-specialist.md`.

- Source role: `unity-addressables-specialist`
