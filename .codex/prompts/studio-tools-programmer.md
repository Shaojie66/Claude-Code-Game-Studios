# studio-tools-programmer

This prompt is generated from the canonical Codex-native source at `.codex/prompt-sources/studio/tools-programmer.md`.

- Source role: `tools-programmer`
