# studio-unity-shader-specialist

This prompt is generated from the canonical Codex-native source at `.codex/prompt-sources/studio/unity-shader-specialist.md`.

- Source role: `unity-shader-specialist`
