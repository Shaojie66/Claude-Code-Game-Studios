...
description: Codex-native workflow for UX review in the game studio template
---

# Studio UX Review

Use this when the user wants to run the UX review workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-ux-review/SKILL.md`
...
Produce a Codex-native UX review outcome that is explicit, repo-grounded, and ready for downstream workflows.
