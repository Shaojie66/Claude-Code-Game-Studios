...
description: Codex-native workflow for asset audit in the game studio template
---

# Studio Asset Audit

Use this when the user wants to run the asset audit workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-asset-audit/SKILL.md`
...
Produce a Codex-native asset audit outcome that is explicit, repo-grounded, and ready for downstream workflows.
