---
name: studio-onboard
description: Codex-native workflow for onboard in the game studio template
---

# Studio Onboard

Use this when the user wants to run the onboard workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-onboard/SKILL.md`
...
Produce a Codex-native onboard outcome that is explicit, repo-grounded, and ready for downstream workflows.
