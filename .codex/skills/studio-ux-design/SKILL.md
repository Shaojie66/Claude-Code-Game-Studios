...
description: Codex-native workflow for UX design in the game studio template
---

# Studio UX Design

Use this when the user wants to run the UX design workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-ux-design/SKILL.md`
...
Produce a Codex-native UX design outcome that is explicit, repo-grounded, and ready for downstream workflows.
