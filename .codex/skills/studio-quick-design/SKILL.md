...
description: Codex-native workflow for quick design in the game studio template
---

# Studio Quick Design

Use this when the user wants to run the quick design workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-quick-design/SKILL.md`
...
Produce a Codex-native quick design outcome that is explicit, repo-grounded, and ready for downstream workflows.
