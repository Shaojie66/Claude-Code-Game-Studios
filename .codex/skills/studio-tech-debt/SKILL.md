...
description: Codex-native review workflow for tech debt in the game studio template
---

# Studio Tech Debt

Use this when the user wants a grounded tech debt pass over a story, feature, system, or release scope.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-tech-debt/SKILL.md`
4. In-scope design docs, code, data, ADRs, QA evidence, or release artifacts relevant to the review target

## Goal

Produce an evidence-backed tech debt verdict with exact findings, risks, and recommended follow-up actions.
