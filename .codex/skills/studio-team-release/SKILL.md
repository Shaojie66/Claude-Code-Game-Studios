...
description: Codex-native team workflow for team release in the game studio template
---

# Studio Team Release

Use this when the user wants to run the team release workflow as a coordinated Codex-native team pass.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-team-release/SKILL.md`
4. In-scope stories, feature specs, or sprint artifacts plus the relevant design, code, and QA evidence

## Goal

Produce a coordinated team release package with clear lanes, concrete outputs, blockers, and a grounded handoff.
