...
description: Codex-native production workflow for bug triage in the game studio template
---

# Studio Bug Triage

Use this when the user wants the bug triage workflow to produce a concrete operational artifact or decision.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-bug-triage/SKILL.md`
...
Produce a concrete bug triage artifact or verdict that reflects the current repo state, dependencies, and open risks.
