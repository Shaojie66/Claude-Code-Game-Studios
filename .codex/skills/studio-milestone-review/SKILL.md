...
description: Codex-native production workflow for milestone review in the game studio template
---

# Studio Milestone Review

Use this when the user wants the milestone review workflow to produce a concrete operational artifact or decision.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-milestone-review/SKILL.md`
...
Produce a concrete milestone review artifact or verdict that reflects the current repo state, dependencies, and open risks.
