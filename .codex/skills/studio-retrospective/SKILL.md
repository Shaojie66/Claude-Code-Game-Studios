...
description: Codex-native production workflow for retrospective in the game studio template
---

# Studio Retrospective

Use this when the user wants the retrospective workflow to produce a concrete operational artifact or decision.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-retrospective/SKILL.md`
...
Produce a concrete retrospective artifact or verdict that reflects the current repo state, dependencies, and open risks.
