...
description: Codex-native production workflow for estimate in the game studio template
---

# Studio Estimate

Use this when the user wants the estimate workflow to produce a concrete operational artifact or decision.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-estimate/SKILL.md`
...
Produce a concrete estimate artifact or verdict that reflects the current repo state, dependencies, and open risks.
