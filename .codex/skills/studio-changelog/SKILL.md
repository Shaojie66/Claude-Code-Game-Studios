...
description: Codex-native production workflow for changelog in the game studio template
---

# Studio Changelog

Use this when the user wants the changelog workflow to produce a concrete operational artifact or decision.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-changelog/SKILL.md`
...
Produce a concrete changelog artifact or verdict that reflects the current repo state, dependencies, and open risks.
