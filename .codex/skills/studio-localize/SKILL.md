...
description: Codex-native workflow for localize in the game studio template
---

# Studio Localize

Use this when the user wants to run the localize workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-localize/SKILL.md`
...
Produce a Codex-native localize outcome that is explicit, repo-grounded, and ready for downstream workflows.
