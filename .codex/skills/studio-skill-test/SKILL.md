...
description: Codex-native workflow for skill test in the game studio template
---

# Studio Skill Test

Use this when the user wants to run the skill test workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-skill-test/SKILL.md`
...
Produce a Codex-native skill test outcome that is explicit, repo-grounded, and ready for downstream workflows.
