...
description: Codex-native production workflow for day one patch in the game studio template
---

# Studio Day One Patch

Use this when the user wants the day one patch workflow to produce a concrete operational artifact or decision.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-day-one-patch/SKILL.md`
...
Produce a concrete day one patch artifact or verdict that reflects the current repo state, dependencies, and open risks.
