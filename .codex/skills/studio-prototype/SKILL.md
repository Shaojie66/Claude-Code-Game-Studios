...
description: Codex-native workflow for prototype in the game studio template
---

# Studio Prototype

Use this when the user wants to run the prototype workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-prototype/SKILL.md`
...
Produce a Codex-native prototype outcome that is explicit, repo-grounded, and ready for downstream workflows.
