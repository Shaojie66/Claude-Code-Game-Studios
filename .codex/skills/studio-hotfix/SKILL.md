---
name: studio-hotfix
description: Codex-native workflow for hotfix in the game studio template
---

# Studio Hotfix

Use this when the user wants to run the hotfix workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-hotfix/SKILL.md`
...
Produce a Codex-native hotfix outcome that is explicit, repo-grounded, and ready for downstream workflows.
