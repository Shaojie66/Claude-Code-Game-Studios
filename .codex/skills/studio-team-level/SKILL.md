...
description: Codex-native team workflow for team level in the game studio template
---

# Studio Team Level

Use this when the user wants to run the team level workflow as a coordinated Codex-native team pass.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-team-level/SKILL.md`
4. In-scope stories, feature specs, or sprint artifacts plus the relevant design, code, and QA evidence

## Goal

Produce a coordinated team level package with clear lanes, concrete outputs, blockers, and a grounded handoff.
