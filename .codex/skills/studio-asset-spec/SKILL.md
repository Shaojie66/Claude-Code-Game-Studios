...
description: Codex-native workflow for asset spec in the game studio template
---

# Studio Asset Spec

Use this when the user wants to run the asset spec workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-asset-spec/SKILL.md`
...
Produce a Codex-native asset spec outcome that is explicit, repo-grounded, and ready for downstream workflows.
