...
description: Codex-native production workflow for reverse document in the game studio template
---

# Studio Reverse Document

Use this when the user wants the reverse document workflow to produce a concrete operational artifact or decision.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-reverse-document/SKILL.md`
...
Produce a concrete reverse document artifact or verdict that reflects the current repo state, dependencies, and open risks.
