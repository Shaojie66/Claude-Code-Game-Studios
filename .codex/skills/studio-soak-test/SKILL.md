...
description: Codex-native workflow for soak test in the game studio template
---

# Studio Soak Test

Use this when the user wants to run the soak test workflow in Codex terms and leave behind a concrete artifact, verdict, or next-step package.

## Read First

1. `AGENTS.md`
2. `docs/codex-port.md`
3. `.codex/skills/studio-soak-test/SKILL.md`
...
Produce a Codex-native soak test outcome that is explicit, repo-grounded, and ready for downstream workflows.
